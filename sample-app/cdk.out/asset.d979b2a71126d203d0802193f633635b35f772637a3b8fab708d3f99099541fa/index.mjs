...
var handler = async (event, context) => {
  ...
  try {
    ...
    const original_function_name = original_function_arn.substring(original_function_arn.lastIndexOf(":") + 1);
    const channel = `/${appsync_channel_namespace}/${original_function_name}/requests`;
